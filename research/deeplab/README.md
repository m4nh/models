...
```
python infer_folder.py --model_variant="xception_65" --atrous_rates=6 --atrous_rates=12 --atrous_rates=18 --output_stride=16 --decoder_output_stride=4 --checkpoint_path /home/daniele/Downloads/deeplab_v3+/model.ckpt
```