...
flags.DEFINE_enum('colormap_type', 'pascal', ['pascal', 'cityscapes', 'cityscapes_mapillary_apolloscapes'],
...
def _process_batch(sess, original_images, semantic_predictions, image_names,
  ...
  for i in range(num_image):
    ...
    pred_filename= image_filename + "_prediction"
    # Save prediction.
    save_annotation.save_annotation(
        crop_semantic_prediction, save_dir, pred_filename,
        add_colormap=True,
